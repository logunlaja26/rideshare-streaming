 ...
 * This event is produced to the driver.location Kafka topic.
 *
...
public record DriverLocationEvent(
    ...
    public static DriverLocationEvent create(String driverId, double lat, double lng, double speed) {
        return new DriverLocationEvent(driverId, lat, lng, Instant.now().toEpochMilli(), speed);
    }
}
